...
#### 4.1.2 Static Member Functions(静态成员函数)
...
#### 4.1.3 Virtual Member Functions(虚函数)
...
#### 4.3.1 支持指向Virtual Member Functions的指针
...
#### 4.3.2 多重继承下，指向Member Functions的指针
...
#### 6.2.3 operator new和operator delete的实现
